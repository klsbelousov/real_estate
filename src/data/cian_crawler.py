...
def get_json(page: int, rooms: int) -> dict:
    """
    Function returns dictionary with page params
...
def get_offer(item: dict):
    """
    Returns specific offer parameters

    :item:
        - dict with all offer params
...
def insertion():
    """
    Function inserts offer params into PostgreSQL table
    """
